...
<html lang="en">
  <head>
    ...
    <title>SIGN IN | Toko Sapatu Online</title>
  ...
  <div class="login-form">    
    <form action="<?=base_url('index.php/user/proses_login')?>" method="post">
        ...
        <input name="login" type="submit" class="btn btn-primary btn-block btn-lg" value="Login">              
        <?php
          if($this->session->flashdata('pesan')!= null){
            echo"<div class='alert alert-success' style='width:300px'>".$this->session->flashdata('pesan')."</div";
          }?>
    </form>			
      <div class="text-center small">Don't have an account? <a href="<?=base_url('index.php/user/register')?>">Sign up</a></div>
  </div>
